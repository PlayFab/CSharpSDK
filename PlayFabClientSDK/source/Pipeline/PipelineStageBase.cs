...
namespace PlayFab.Pipeline
{
    ...
    internal abstract class PipelineStageBase<TInputItem, TOutputItem> : IPipelineStage<TInputItem, TOutputItem>
    {
        ...
        /// </summary>
        //public event EventHandler<PipelineStageNotificationEventArgs<TInputItem, TOutputItem>> RaiseStageNotificationEvent;
        /*
        // Conventional wrapper of event invocations inside a protected virtual method
        // to allow derived classes to fire the event and to override the event invocation behavior
        protected virtual void OnRaiseStageNotificationEvent(PipelineStageNotificationEventArgs<TInputItem, TOutputItem> e)
        {
            // Make a temporary copy of the event to avoid possibility of
            // a race condition if the last subscriber unsubscribes
            // immediately after the null check and before the event is raised.
            var handler = RaiseStageNotificationEvent;
