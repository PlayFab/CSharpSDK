...
namespace PlayFab
{
    ...
    public class PlayFabClientInstanceAPI
    {
        ...
        public async Task<PlayFabResult<CurrentGamesResult>> GetCurrentGamesAsync(CurrentGamesRequest request, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            ...
            var httpResult = await PlayFabHttp.DoPost("/Client/GetCurrentGames", request, "X-Authorization", requestContext.ClientSessionTicket, extraHeaders, requestSettings);
            if (httpResult is PlayFabError)
            {
                var error = (PlayFabError)httpResult;
                PlayFabSettings.GlobalErrorHandler?.Invoke(error);
        ...
        public async Task<PlayFabResult<GameServerRegionsResult>> GetGameServerRegionsAsync(GameServerRegionsRequest request, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            ...
            var httpResult = await PlayFabHttp.DoPost("/Client/GetGameServerRegions", request, "X-Authorization", requestContext.ClientSessionTicket, extraHeaders, requestSettings);
            if (httpResult is PlayFabError)
            {
                var error = (PlayFabError)httpResult;
                PlayFabSettings.GlobalErrorHandler?.Invoke(error);
        ...
        /// </summary>
        public async Task<PlayFabResult<EmptyResult>> LinkNintendoSwitchAccountAsync(LinkNintendoSwitchAccountRequest request, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            await new PlayFabUtil.SynchronizationContextRemover();
            ...
            var httpResult = await PlayFabHttp.DoPost("/Client/LinkNintendoSwitchAccount", request, "X-Authorization", requestContext.ClientSessionTicket, extraHeaders, requestSettings);
            if (httpResult is PlayFabError)
            {
                var error = (PlayFabError)httpResult;
                PlayFabSettings.GlobalErrorHandler?.Invoke(error);
        ...
        /// </summary>
        public async Task<PlayFabResult<LoginResult>> LoginWithNintendoSwitchAccountAsync(LoginWithNintendoSwitchAccountRequest request, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            await new PlayFabUtil.SynchronizationContextRemover();
            ...
            var httpResult = await PlayFabHttp.DoPost("/Client/LoginWithNintendoSwitchAccount", request, null, null, extraHeaders, requestSettings);
            if (httpResult is PlayFabError)
            {
                var error = (PlayFabError)httpResult;
                PlayFabSettings.GlobalErrorHandler?.Invoke(error);
        ...
        public async Task<PlayFabResult<MatchmakeResult>> MatchmakeAsync(MatchmakeRequest request, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            ...
            var httpResult = await PlayFabHttp.DoPost("/Client/Matchmake", request, "X-Authorization", requestContext.ClientSessionTicket, extraHeaders, requestSettings);
            if (httpResult is PlayFabError)
            {
                var error = (PlayFabError)httpResult;
                PlayFabSettings.GlobalErrorHandler?.Invoke(error);
        ...
        /// </summary>
        public async Task<PlayFabResult<EmptyResponse>> UnlinkNintendoSwitchAccountAsync(UnlinkNintendoSwitchAccountRequest request, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            await new PlayFabUtil.SynchronizationContextRemover();
            ...
            var httpResult = await PlayFabHttp.DoPost("/Client/UnlinkNintendoSwitchAccount", request, "X-Authorization", requestContext.ClientSessionTicket, extraHeaders, requestSettings);
            if (httpResult is PlayFabError)
            {
                var error = (PlayFabError)httpResult;
                PlayFabSettings.GlobalErrorHandler?.Invoke(error);
